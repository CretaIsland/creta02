...
class AppwriteUserDb extends AbsUserDb {
  // @override
  ...
  Future<void> createAccount(Map<String, dynamic> createUserData) async {
    ...
    await HycopFactory.myDataBase!.createData('hycop_users', 'user=$userForeignKey', createUserData).catchError(
        (error, stackTrace) =>
            throw HycopUtils.getHycopException(error: error, defaultMessage: 'createData Error !!!'));
    // final getUserData = await HycopFactory.myDataBase!.getData('hycop_users', 'user=$userForeignKey').catchError(
  ...
  Future<void> updateAccountInfo(Map<String, dynamic> updateUserData) async {
    ...
    await HycopFactory.myDataBase!.setData('hycop_users', 'user=$userForeignKey', updateUserData).catchError(
  ...
  Future<void> updateAccountPassword(String newPassword, String oldPassword) async {
    ...
    await HycopFactory.myDataBase!.setData('hycop_users', 'user=$userForeignKey', newUserData).catchError(
        (error, stackTrace) => throw HycopUtils.getHycopException(error: error, defaultMessage: 'setData Error !!!'));
  }
  ...
  Future<void> login(String email, String password,
    ...
    if (result.userId.isEmpty) {
      ...
      final resultUserData = await HycopFactory.myDataBase!.getData('hycop_users', 'user=${userObject.name}').catchError(
          (error, stackTrace) =>
